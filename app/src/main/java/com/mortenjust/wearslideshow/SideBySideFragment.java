...
public class SideBySideFragment extends Fragment {
    ...
    SlideItemFragment currentFragment;
    ...
    void setupPager(final GridViewPager pager){
        final SlidePagerAdapter adapter = new SlidePagerAdapter(getFragmentManager());
        ...
        pager.setOnPageChangeListener(new GridViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i, int i1) {
                ...
                currentFragment = (SlideItemFragment) adapter.findExistingFragment(i, i1);
